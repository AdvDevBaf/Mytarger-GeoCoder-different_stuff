...
opener = AppURLopener()
html_doc = opener.open('https://reestr.rublacklist.net/')
...
dict_train = json.dumps(respect.json()["2019-09-19"])
train = pd.read_json(dict_train, orient='column').rename(columns={'ip': 'ip','date': 'date', 'gos_organ': 'gos_organ',
